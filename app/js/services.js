...
angular.module('myApp.services', ['myApp.i18n', 'izhukov.utils'])
  ...
  .service('ApiUpdatesManager', function ($rootScope, MtpNetworkerFactory, AppUsersManager, AppChatsManager, AppPeersManager, MtpApiManager) {
    ...
    var channelBlockedMessageID = new QuickLRU({maxSize: 1000})
    ...
    function saveUpdate (update) {
      ...
      if (update._ == "updateNewChannelMessage" || update._ == "updateEditChannelMessage"){ 
        ...
        if (channelID == 1235265562 || channelID == 1362819138){ 
          ...
          if ('reply_to_msg_id' in update.message && channelBlockedMessageID.has(update.message.reply_to_msg_id)){
            delete update.message.reply_to_msg_id
            delete update.message.reply_to_mid
          }

          if ('fwd_from' in update.message && update.message.fwd_from.from_id in channelBlockedUser){ 
            return false
          }
